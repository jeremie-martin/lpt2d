    ...
    *,
    ...
    if a_m is not None and b_m is not None:
        mc = compare_metrics(
            ...
            a_luma_histogram=result_luma_histogram(a_result),
            ...
            b_luma_histogram=result_luma_histogram(b_result),
...
def compare_to_baseline(
    ...
    *,
    ...
    mc = None
    r_m = result.metrics
    b_m = normalize_baseline_metrics(baseline.get("metrics"))
    if r_m is not None and b_m is not None:
        mc = compare_metrics(
            ...
            a_luma_histogram=result_luma_histogram(result),
            b_mean_luma=b_m["mean_luma"],
            b_median_luma=b_m["median_luma"],
            b_p95_luma=b_m["p95_luma"],
            b_near_black_fraction=b_m["near_black_fraction"],
