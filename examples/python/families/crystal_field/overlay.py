...
_METRIC_ORDER: tuple[tuple[str, str, str], ...] = (
    ...
    ("mean_luma", "mean_luma", "%.3f"),
    ("median_luma", "median_luma", "%.3f"),
    ("p05_luma", "p05_luma", "%.3f"),
    ("p95_luma", "p95_luma", "%.3f"),
    ("p10_luma", "p10_luma", "%.3f"),
    ("p90_luma", "p90_luma", "%.3f"),
    ("rms_contrast", "rms_contrast", "%.3f"),
    ("interdecile_luma_range", "interdecile_range", "%.3f"),
    ("interdecile_luma_contrast", "interdecile_contrast", "%.3f"),
    ("local_contrast", "local_contrast", "%.3f"),
    ("luma_entropy_normalized", "luma_entropy", "%.3f"),
    ...
    ("p95_saturation", "p95_saturation", "%.3f"),
    ("colorfulness", "colorfulness", "%.3f"),
    ("bright_neutral_fraction", "bright_neutral", "%.1f%%"),
